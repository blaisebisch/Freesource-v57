...
const Resource: React.FC<{ topicColor: any }> = ({ topicColor }) => {
  ...
  const rText = "This is a free digital resource for creating a button with Ionic.";
  const rLink =
          ...
          <IonRow className="resourceRow">
            <IonCol>
              <IonText color={topicColor}>
                <IonTitle size="large" style={{ fontFamily: "'Inter'", color:"white", }}>
                  {rTitle}
                </IonTitle>
                <IonText className="resourceText" style={{ fontFamily: "'Inter'", color:"white", }}>{rText}</IonText>
              </IonText>
            </IonCol>
            <IonCol>
              <IonButton
